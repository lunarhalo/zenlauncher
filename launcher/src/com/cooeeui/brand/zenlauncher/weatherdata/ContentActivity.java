...
public class ContentActivity extends Activity {
    ...
    // private Drawable drawCurveCurPage;
    // private Drawable drawCurveOtherPage;
    // private Drawable drawcityCurPage;
    // private Drawable drawcityOtherPage;
    ...
    private static View viewParent = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // drawCurveCurPage = this.getResources().getDrawable(
        // R.drawable.indicator_dateclick);
        // drawCurveOtherPage = this.getResources().getDrawable(
        // R.drawable.indicator_date);
        // drawcityCurPage = this.getResources().getDrawable(
        // R.drawable.indicator_cityclick);
        // drawcityOtherPage = this.getResources().getDrawable(
        // R.drawable.indicator_city);
        ...
        if (Parameter.enable_google_version) {
            if (sharepreference.getBoolean("numberweatherstate", false)) {
                ...
                if (flag == 0) {
                    // curve.setImageDrawable(drawCurveCurPage);
                    // city.setImageDrawable(drawcityOtherPage);
                    AnimSetTo(ContentActivity.this, city, curve, 0f);
                } else if (flag == 1) {
                    // curve.setImageDrawable(drawCurveOtherPage);
                    // city.setImageDrawable(drawcityCurPage);
