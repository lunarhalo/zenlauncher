    ...
    public void flushAllViews(Context context, WeatherEntity weatherentity) {
        if (weatherentity != null && weatherentity.getDetails() != null
            ...
            ivweatherconditionname.setImageBitmap(NumberClockHelper.drawString(
                    context, weatherentity.getDetails().get(0).getCondition(),
                    weatherentity.getDetails().get(1).getCondition(),
                    weatherentity.getDetails().get(2).getCondition(),
                    weatherentity.getDetails().get(3).getCondition(),
                    weatherentity.getDetails().get(4).getCondition()));
