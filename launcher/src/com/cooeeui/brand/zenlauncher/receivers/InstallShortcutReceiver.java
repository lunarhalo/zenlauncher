...
package com.cooeeui.brand.zenlauncher.receivers;
...
public class InstallShortcutReceiver extends BroadcastReceiver {
            ...
            if (strings != null) {
                ...
                while (newStringsIter.hasNext()) {
                    ...
                    try {
                        ...
                        Intent launchIntent = Intent.parseUri(object.getString(LAUNCH_INTENT_KEY),
                                0);
    ...
    public void onReceive(Context context, Intent data) {
        ...
        boolean launcherNotLoaded = false;// (app.getDynamicGrid() == null);
    ...
    static void flushInstallQueue(Context context) {
        ...
        if (!installQueue.isEmpty()) {
            ...
            if (!addShortcuts.isEmpty()) {
                LauncherAppState app = LauncherAppState.getInstance();
                app.getModel().addAndBindAddedApps(context, null);
            }
        }
    }
